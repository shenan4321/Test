...
public class BinaryGeometryMessagingStreamingSerializerPlugin2 implements MessagingStreamingSerializerPlugin {
	...
	public MessagingStreamingSerializer createSerializer(PluginConfiguration plugin) {
		return new BinaryGeometryMessagingStreamingSerializer2();
	}
}