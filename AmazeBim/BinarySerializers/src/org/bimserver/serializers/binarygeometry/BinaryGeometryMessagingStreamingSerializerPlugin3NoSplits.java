...
public class BinaryGeometryMessagingStreamingSerializerPlugin3NoSplits implements MessagingStreamingSerializerPlugin {
	...
	public MessagingStreamingSerializer createSerializer(PluginConfiguration plugin) {
		return new BinaryGeometryMessagingStreamingSerializer3NoSplits();
	}
}